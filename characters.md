...
- **CONFIRMED AS A WIZARD (Ch16):** Pip told Marian directly and explicitly — "He's a wizard. A genuine one." — along with the debt's exact terms (keep Robin alive, out of the noose, called in by Robin's father). This is the first explicit textual confirmation to any character or the reader, not just accumulated suspicion. **Thistlewood himself was not present for this conversation and does not yet know Marian knows** — worth deciding in a future chapter whether/when he finds out, and how he reacts to Pip having told her.
